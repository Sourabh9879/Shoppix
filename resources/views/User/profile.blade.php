    ...
    <div class="row">
            ...
            <div class="card shadow-sm p-4" style="min-width: 555px">
                ...
                <div class="text-center">
                    <div class="position-relative d-inline-block">
                        @if ($data->image)
                        <img id="profilePreview" src="{{ asset('storage/' . $data->image) }}"
                            class="rounded-circle img-thumbnail mb-3" style="width: 120px; height: 120px;">
                        @else
        ...
        <div class="col-6 d-flex align-items-start justify-content-start">
            <div class="card shadow-sm p-4" style="min-width: 444px">
                ...
                <form action="{{ route('changePassword') }}" method="POST" autocomplete="off">
                    @csrf
